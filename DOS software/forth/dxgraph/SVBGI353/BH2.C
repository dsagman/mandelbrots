...
#define VERSION 	2		/* Version Number of header	*/
...
char mask[] = "pk\010\010BGI Device Driver (%s) " UPDATE " - " __DATE__ "\r\n"
	      "(c) 1991-95 Ullrich von Bassewitz. Update by " AUTHOR "\r\n";

char help[] = "BGI Type-2 Driver Builder\n\n"
              "Usage is:  BH2 input[.BIN] output[.BGI] [drv_name]\n\n"
